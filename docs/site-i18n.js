...
(function () {
  ...
  var dicts = {
    en: {
      ...
      winRelease: "Current release: <strong>V0.7.50</strong> · Updated 2026-08-21",
      ...
      winBtnWith: "Download Windows MSI with Engine",
      winBtnWithout: "Download Windows MSI without Engine",
      ...
      macRelease: "Current release: <strong>V0.7.50</strong> · Updated 2026-08-21",
      macAuto: "Your download should start automatically.",
    ...
    zh: {
      ...
      winRelease: "当前版本：<strong>V0.7.50</strong> · 更新于 2026-08-21",
      winChoose: "选择带内置 KataGo 引擎或不带引擎的安装包。",
      winEngineNote: "含引擎版安装包自带 KataGo OpenCL 引擎，安装完成后即可开始分析。",
      winBtnWith: "下载 Windows MSI（含引擎）",
      winBtnWithout: "下载 Windows MSI（不含引擎）",
      ...
      macRelease: "当前版本：<strong>V0.7.50</strong> · 更新于 2026-08-21",
      macAuto: "下载将自动开始。",
    ...
    ja: {
      ...
      winRelease: "現在のリリース：<strong>V0.7.50</strong> · 更新日 2026-08-21",
      winChoose: "KataGo エンジン同梱版・非同梱版のどちらかを選べます。",
      winEngineNote: "エンジン同梱版には KataGo OpenCL エンジンが含まれており、インストール後すぐに分析できます。",
      winBtnWith: "Windows MSI（エンジン同梱）をダウンロード",
      winBtnWithout: "Windows MSI（エンジンなし）をダウンロード",
      ...
      macRelease: "現在のリリース：<strong>V0.7.50</strong> · 更新日 2026-08-21",
      macAuto: "ダウンロードは自動的に開始されます。",
    ...
    ko: {
      ...
      winRelease: "현재 릴리스: <strong>V0.7.50</strong> · 업데이트 2026-08-21",
      winChoose: "KataGo 엔진 포함 또는 미포함 설치 프로그램을 선택하세요.",
      winEngineNote: "엔진 포함 버전에는 KataGo OpenCL 엔진이 들어 있어 설치 후 바로 분석할 수 있습니다.",
      winBtnWith: "Windows MSI (엔진 포함) 다운로드",
      winBtnWithout: "Windows MSI (엔진 미포함) 다운로드",
      ...
      macRelease: "현재 릴리스: <strong>V0.7.50</strong> · 업데이트 2026-08-21",
      macAuto: "다운로드가 자동으로 시작됩니다.",
