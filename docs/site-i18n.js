...
(function () {
  ...
  var dicts = {
    en: {
      ...
      winRelease: "Current release: <strong>V0.7.25</strong>",
      ...
      macRelease: "Current release: <strong>V0.7.25</strong>",
    ...
    zh: {
      ...
      winRelease: "当前版本：<strong>V0.7.25</strong>",
      ...
      macRelease: "当前版本：<strong>V0.7.25</strong>",
      macAuto: "下载将自动开始。",
    ...
    ja: {
      ...
      winRelease: "現在のリリース：<strong>V0.7.25</strong>",
      ...
      macRelease: "現在のリリース：<strong>V0.7.25</strong>",
    ...
    ko: {
      ...
      winRelease: "현재 릴리스: <strong>V0.7.25</strong>",
      ...
      macRelease: "현재 릴리스: <strong>V0.7.25</strong>",
